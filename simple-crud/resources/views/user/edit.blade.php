...
<div class="container" background="white">
    <x-jet-authentication-card>
        <x-slot name="logo">
            <img src="https://upload.wikimedia.org/wikipedia/id/0/0a/Pelindo_IV.svg" width="400">
        </x-slot>
        ...
        <form action="{{route('user.update', $item->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <x-jet-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{ $item->name }}" required
